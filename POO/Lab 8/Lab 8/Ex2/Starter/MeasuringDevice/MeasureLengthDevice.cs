...
namespace MeasuringDevice
{
    ...
    // add a public class named MeasureLengthDevice
    // use the wizard to implement the interface methods
    public class MeasureLengthDevice : IMeasuringDevice
    {
        ...
        public decimal ImperialValue()
        {
            if (unitsToUse == Units.Imperial) {
                ...
                double v = mostRecentMeasure * 0.03937;
                return (decimal)v;
            }
        }
        ...
        public decimal MetricValue()
        {
            if (unitsToUse == Units.Metric) {
                ...
                double v = mostRecentMeasure * 25.4;
                return (decimal)v;
            }
        }
